...
#'
#' The input for the main patternize functions are \code{RasterStack} objects and when landmark transformation is used, landmark arrays.
#'
#' \code{makeList} \cr
...
#'
#'
#' @seealso \code{\link[raster]{raster}}, \code{\link[raster]{stack}}, \code{\link[Morpho]{procSym}}, \code{\link[Morpho]{computeTransform}}, \code{\link[RNiftyReg]{niftyreg}}
#'
#' @docType package
#' @name patternize
NULL
